...
import esa.open.lib.common.ui.compatibility.CompatibilityUtilities;
import esa.open.lib.core.service.ISystemContext;
import esa.open.lib.core.ui.actions.ApplicationInformationAction;
import esa.open.lib.core.ui.actions.ViewNavigationHistoryAction;
import esa.open.lib.workspace.actions.OpenWorkspaceViewAction;
...
public class ApplicationActionBarAdvisor extends ActionBarAdvisor
{
    ...
    /** The Application Information Action in the Help menu */
    private IAction applicationInformationAction;
    ...
    /** The Help Action in the Help menu */
    private IWorkbenchAction showHelpAction;

    /** The Search Help Action in the Help menu */
    ...
    protected void makeActions(final IWorkbenchWindow window)
    {
        ...
        this.applicationInformationAction = new ApplicationInformationAction();
        register(this.applicationInformationAction);
    ...
    protected void fillMenuBar(IMenuManager menuBar)
    {
        ...
        if (!CompatibilityUtilities.INSTANCE.isRAPApplication())
        {
            ...
            helpMenu.add(this.searchHelpAction);
        ...
        helpMenu.add(this.applicationInformationAction);
    }
