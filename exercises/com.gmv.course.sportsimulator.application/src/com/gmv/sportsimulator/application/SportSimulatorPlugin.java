...
import esa.egos.eud.common.AbstractEudPlugin;
import esa.egos.eud.common.ui.EudAbstractUIPlugin;
import esa.egos.eud.core.ui.CoreUiPlugin;
import esa.egos.eud.core.ui.preferences.PreferenceConstants;

/**
 * @author Jean Schuetz
 * 
 */
public class SportSimulatorPlugin extends EudAbstractUIPlugin
{
    /** The shared instance */
    private static SportSimulatorPlugin plugin;
...
//                .setValue(PreferenceConstants.P_EUD_PARAM_BROWSER_MAX_FILTER_LEVEL, 100);
     ...
     */
    public static SportSimulatorPlugin getDefault()
    {
        return plugin;
    }
